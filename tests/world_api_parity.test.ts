...
//
// `IWorld` (src/world_api.ts, 151 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (151 / 38 / 113)
...
// Partition: 38 `data` + 113 `method` (read-returning + command-void + 3 async).
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 21 facets', () => {
  ...
  it('the union of the 21 facets equals the pinned 151-member IWORLD_MEMBERS set', () => {
