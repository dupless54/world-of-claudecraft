...
// it lands the matching edit here in the SAME commit. The count pins (239 / 64 / 175)
...
// Partition: 64 `data` + 175 `method` (read-returning + command-void + async).
...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  ...
  it('the sorted method-kind set is exactly the pinned 175', () => {
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 28 facets', () => {
  ...
  it('the union of the 28 facets equals the pinned 239-member IWORLD_MEMBERS set', () => {
