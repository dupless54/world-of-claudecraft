...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.deedsPage.cat.pvp': 'Игрок против игрока',
  'guide.deedsPage.cat.social': 'Общение и экономика',
  ...
  'guide.deedsPage.howBody':
    'Деяния зарабатываются по одному персонажу за раз и отображаются для всей вашей учетной записи, так что каждый герой, за которого вы играете, пополняет одну и ту же коллекцию. Каждое деяние ясно указывает, что от вас требуется, прямо в Книге деяний в игре, так что вы всегда знаете, к чему стремиться. Немногие остаются тайными и раскрываются лишь после того, как вы их заработаете.',
  ...
  'guide.deedsPage.rewardsBody':
    'Награды нужны лишь для вида, и в этом весь смысл. Некоторые деяния даруют звание, которое можно носить, или рамку, обрамляющую ваше имя, но никогда ничего, что сделало бы вашего героя сильнее. Выберите желаемое звание в Книге деяний, и оно будет сопровождать вашу именную табличку на виду у всех.',
  'guide.deedsPage.rewardsHeading': 'Звания и рамки',
  'guide.deedsPage.standingsNote':
    'Королевства ведут текущий подсчет Известности по всем учетным записям. Чтобы увидеть, кто где стоит, откройте Книгу деяний в игре и перейдите к таблице Известности; она находится там, а не на вики.',
