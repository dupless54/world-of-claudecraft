...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'loading.tips.talents':
    'Совет: очки талантов можно сбросить у любого наставника в любой момент, так что экспериментировать не страшно.',
  'loading.tips.dungeons':
    'Совет: сложность подземелий подстраивается под размер группы. С друзьями прохождение быстрее и безопаснее.',
  'loading.tips.market': 'Совет: на Мировом рынке можно покупать и продавать вещи игрокам всего мира.',
  'loading.tips.guilds': 'Совет: вступление в гильдию открывает групповой контент и общий канал чата.',
  'loading.tips.professions':
    'Совет: сбор и крафтовые профессии можно развивать параллельно с боевым классом.',
  'loading.tips.mounts':
    'Совет: ездовые животные открываются на высоких уровнях и значительно ускоряют перемещение между зонами.',
  'loading.tips.pvp':
    'Совет: если хотите проверить свою сборку против других игроков, поищите отмеченные зоны PvP.',
};
