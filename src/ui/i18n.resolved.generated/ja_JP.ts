...
export const ja_JP: EnTranslations = {
  ...
  "guide": {
    ...
    "deedsPage": {
      ...
      "howHeading": "功績の仕組み",
      "howBody": "功績はキャラクターごとに一つずつ獲得され、アカウント全体に表示されます。だからあなたが遊ぶすべての英雄が、同じ一つのコレクションに加わっていきます。それぞれの功績は、ゲーム内の功績の書で何を求めているかをはっきりと示すので、次に何を目指すべきかが常に分かります。ごく一部の功績は秘密のままで、獲得して初めて姿を現します。",
      "renownHeading": "名声",
      ...
      "rewardsBody": "報酬はすべて見せびらかすためのもので、それこそが狙いです。一部の功績は、身につけられる称号や、名前を彩る枠飾りを授けますが、英雄を強くするものは決して与えません。功績の書で好きな称号を選べば、それがあなたのネームプレートに添えられ、誰の目にも映ります。",
