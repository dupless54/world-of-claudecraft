...
export const ja_JP: EnTranslations = {
  ...
  "loading": {
    ...
    "tips": {
      ...
      "talents": "ヒント：タレントポイントはいつでもトレーナーのもとでリセットできるので、気軽に試せます。",
      "dungeons": "ヒント：ダンジョンはパーティ人数に応じて難易度が調整されます。仲間と挑めばより速く安全にクリアできます。",
      "market": "ヒント：ワールドマーケットではサーバー中のプレイヤーと売買ができます。",
      "guilds": "ヒント：ギルドに加入するとグループコンテンツと専用チャットチャンネルが解放されます。",
      "professions": "ヒント：採集や製作の生産系スキルは、戦闘クラスと並行して育てられます。",
      "mounts": "ヒント：マウントは高レベルで解放され、エリア間の移動が大幅に速くなります。",
      "pvp": "ヒント：自分のビルドを他プレイヤーと試したいなら、PvPエリアを探してみましょう。"
    }
  },
  "errors": {
