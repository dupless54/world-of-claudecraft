...
export const id_ID: EnTranslations = {
  ...
  "guide": {
    ...
    "faqPage": {
      ...
      "a10": "Batasnya adalah level {cap}. Dari sana kamu menjalankan ruang bawah tanah untuk lima pemain dan raid untuk sepuluh pemain, menantangnya lagi dalam mode heroik demi jarahan yang ditingkatkan, menghadapi bos dunia saat ia bangkit, dan menguji dirimu di arena.",
    ...
    "deedsPage": {
      ...
      "howBody": "Jasa diraih oleh satu karakter pada satu waktu dan ditampilkan untuk seluruh akunmu, sehingga setiap pahlawan yang kamu mainkan menambah koleksi yang sama. Setiap jasa menuliskan dengan gamblang apa yang dimintanya darimu, langsung di Kitab Jasa dalam permainan, jadi kamu selalu tahu apa yang harus dikejar, dan kamu bisa memantau jasa yang sedang kamu incar agar tetap terlihat selagi bermain. Segelintir jasa tetap dirahasiakan dan baru menampakkan diri setelah kamu meraihnya. Kitab itu pun menjaga dirinya tetap jujur: apa pun yang bisa dibuktikan oleh catatan masa lalumu akan dikreditkannya seketika, sehingga seorang veteran tak pernah membukanya ke halaman kosong; hanya jasa penghitung yang memulai hitungannya dari awal.",
      ...
      "standingsNote": "Realm-realm menyimpan hitungan berjalan Kemasyhuran di setiap akun. Untuk melihat siapa berdiri di mana, buka Kitab Jasa dalam permainan dan lihat papan peringkat Kemasyhuran; papan itu ada di sana, bukan di wiki ini.",
      ...
      "cat": {
        ...
        "chronicle": "Kronik",
        "collection": "Koleksi",
        "pvp": "Pemain lawan Pemain",
        "social": "Sosial dan Ekonomi",
