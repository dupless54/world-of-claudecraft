...
export const vi_VN: EnTranslations = {
  ...
  "guide": {
    ...
    "faqPage": {
      ...
      "a10": "Giới hạn là cấp {cap}. Từ đó bạn chạy các hầm ngục năm người và raid mười người, thử lại chúng ở chế độ Anh Hùng để nhận chiến lợi phẩm nâng cấp, đối mặt với trùm thế giới khi hắn trỗi dậy, và thử sức ở đấu trường.",
    ...
    "deedsPage": {
      ...
      "standingsNote": "Các vương quốc luôn ghi sổ Danh Vọng của mọi tài khoản. Muốn biết ai đứng ở đâu, hãy mở Sách Kỳ Công trong trò chơi và lật đến bảng xếp hạng Danh Vọng; bảng này nằm ở đó, không nằm trên wiki.",
