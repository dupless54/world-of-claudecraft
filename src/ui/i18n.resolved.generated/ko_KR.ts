...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "deedsPage": {
      ...
      "howBody": "업적은 캐릭터마다 하나씩 얻으며 계정 전체에 걸쳐 표시되므로, 당신이 플레이하는 모든 영웅이 같은 수집에 보태집니다. 각 업적은 게임 내 업적의 서에서 무엇을 요구하는지 분명히 알려 주므로, 무엇을 좇아야 할지 언제나 알 수 있습니다. 소수의 업적은 비밀로 남아 있다가 당신이 얻은 뒤에야 모습을 드러냅니다.",
      "renownHeading": "명성",
      ...
      "rewardsBody": "보상은 모두 과시를 위한 것이며, 바로 그것이 핵심입니다. 일부 업적은 걸칠 수 있는 칭호나 이름을 꾸미는 테두리를 주지만, 영웅을 더 강하게 만드는 것은 결코 주지 않습니다. 업적의 서에서 원하는 칭호를 고르면 그것이 당신의 이름표에 따라붙어 모두에게 보입니다.",
