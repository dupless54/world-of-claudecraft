...
export const da_DK: EnTranslations = {
  ...
  "guide": {
    ...
    "faqPage": {
      ...
      "a10": "Grænsen er niveau {cap}. Derfra løber du fangehullerne for fem spillere og raidet for ti, tager dem igen i heroisk tilstand for opgraderet bytte, møder verdensbossen når han rejser sig, og afprøver dig selv i arenaen.",
    ...
    "deedsPage": {
      ...
      "standingsNote": "Rigerne fører et løbende regnskab over hæder på tværs af alle konti. Vil du se, hvem der står hvor, så åbn Bedrifternes Bog inde i spillet og slå op på Hæder-ranglisten; den bor der, ikke på wikien.",
