...
export const es_ES: EnTranslations = {
  ...
  "guide": {
    ...
    "faqPage": {
      ...
      "a10": "El límite es el nivel {cap}. A partir de ahí recorres las mazmorras de cinco jugadores y la banda de diez jugadores, las afrontas de nuevo en modo heroico para conseguir botín mejorado, te enfrentas al jefe del mundo cuando se alza y te pones a prueba en la arena.",
    ...
    "deedsPage": {
      ...
      "standingsNote": "Los reinos llevan un recuento continuo del Renombre de cada cuenta. Para ver quién ocupa cada puesto, abre el Libro de Gestas dentro del juego y consulta la clasificación de Renombre: está allí, no en la wiki.",
