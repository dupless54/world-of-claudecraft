...
export const ru_RU: EnTranslations = {
  ...
  "loading": {
    ...
    "tips": {
      ...
      "talents": "Совет: очки талантов можно сбросить у любого наставника в любой момент, так что экспериментировать не страшно.",
      "dungeons": "Совет: сложность подземелий подстраивается под размер группы. С друзьями прохождение быстрее и безопаснее.",
      "market": "Совет: на Мировом рынке можно покупать и продавать вещи игрокам всего мира.",
      "guilds": "Совет: вступление в гильдию открывает групповой контент и общий канал чата.",
      "professions": "Совет: сбор и крафтовые профессии можно развивать параллельно с боевым классом.",
      "mounts": "Совет: ездовые животные открываются на высоких уровнях и значительно ускоряют перемещение между зонами.",
      "pvp": "Совет: если хотите проверить свою сборку против других игроков, поищите отмеченные зоны PvP."
    }
  },
  "errors": {
