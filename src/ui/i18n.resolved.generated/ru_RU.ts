...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "crafting": {
      ...
      "stationOutOfRange": "Чтобы создать это, подойдите к станции ремесленного центра.",
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "brain_freeze": "Ледяные стрелы иногда делают следующую «Зимнюю плеть» мгновенной и более мощной.",
  ...
  "entities": {
    "abilities": {
      ...
      "flurry": {
        "name": "Зимняя плеть",
        "description": "Выпускает три ледяных снаряда, каждый из которых наносит {damage} ед. урона от магии льда, и накладывает на цель «Зимнюю стужу»: следующие 2 подходящих заклинания считают её замороженной. «Заморозка мозгов» делает «Зимнюю плеть» мгновенной, усиливает на 30% и позволяет игнорировать время восстановления. (ветка «Лёд»)"
      },
      "frozen_orb": {
        "name": "Ледяной шар",
      ...
      "brain_freeze": {
        ...
        "description": "«Копьё инея» с вероятностью 20% делает следующую «Зимнюю плеть» мгновенной, усиливает её на 30% и позволяет игнорировать время восстановления. (ветка «Лёд»)"
      },
      "shatter": {
