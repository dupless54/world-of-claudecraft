...
export const it_IT: EnTranslations = {
  ...
  "guide": {
    ...
    "faqPage": {
      ...
      "a10": "Il limite è il livello {cap}. Da lì affronti i dungeon a cinque giocatori e l'incursione a dieci, li ripeti in modalità eroica per bottino migliorato, sfidi il boss del mondo quando si erge e ti metti alla prova nell'arena.",
    ...
    "deedsPage": {
      ...
      "howBody": "Le imprese si ottengono con un personaggio alla volta e si mostrano su tutto l'account, così ogni eroe che giochi arricchisce la stessa collezione. Ogni impresa dichiara chiaramente che cosa ti chiede, direttamente nel Libro delle Imprese in gioco, così sai sempre a che cosa dare la caccia, e puoi seguire quelle che ti stanno a cuore per tenerle in vista mentre giochi. Poche restano segrete e si rivelano soltanto una volta ottenute. Il Libro si mantiene anche onesto: tutto ciò che il tuo passato può dimostrare, te lo accredita all'istante, così un veterano non lo apre mai su una pagina vuota; solo le imprese a conteggio iniziano il loro computo da zero.",
      "renownHeading": "Fama",
      ...
      "standingsNote": "I reami tengono un conteggio continuo della Fama di ogni account. Per vedere chi sta dove, apri il Libro delle Imprese in gioco e consulta la classifica della Fama: vive lì, non sulla wiki.",
