...
export const nl_NL: EnTranslations = {
  ...
  "guide": {
    ...
    "faqPage": {
      ...
      "a10": "De limiet is niveau {cap}. Vanaf daar speel je de kerkers voor vijf spelers en de raid voor tien, neem je ze opnieuw op in heroïsche modus voor betere buit, treed je de wereldbaas tegemoet wanneer hij verrijst, en stel je jezelf op de proef in de arena.",
    ...
    "worldPage": {
      ...
      "valePlaceNotes": "Oostbeek is je eerste thuisbasis. Wolvenloop en Everweide zijn rustig jachtgebied; Spiegelmeer is stil water om te vissen; het Sableweb en de Kopergroeve verbergen spinnen en ertsbeluste delvers; een Bandietenkamp en de Gevallen Kapel bieden ruwer werk; Reliekschrijnheuvel leidt naar het Ingestorte Reliekschrijn, de eerste delve van het rijk; Lichtwoudgaarde is een kalm, zonovergoten bosje in het noorden; en het Zeugveld is Oostbeeks ommuurde zwijnenbalveld, waar de Koperen Emmer onder een oogstbestand wordt gespeeld.",
    ...
    "deedsPage": {
      ...
      "standingsNote": "Elk rijk houdt een doorlopende telling van Roem bij over elk account. Om te zien wie waar staat, open je het Boek der Daden in het spel en blader je naar de Roem-ranglijst; die vind je daar, niet op de wiki.",
      ...
      "cat": {
        ...
        "pvp": "Speler tegen Speler",
        "social": "Sociaal en Economie",
