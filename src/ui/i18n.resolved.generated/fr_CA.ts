...
export const fr_CA: EnTranslations = {
  ...
  "guide": {
    ...
    "faqPage": {
      ...
      "a10": "Le plafond est le niveau {cap}. Ensuite, vous parcourez les donjons à cinq joueurs et le raid à dix joueurs, les affrontez de nouveau en mode héroïque pour un meilleur butin, faites face au boss de monde quand il se dresse, et vous mesurez aux autres dans l'arène.",
    ...
    "deedsPage": {
      ...
      "standingsNote": "Les royaumes tiennent un décompte continu de la Renommée de chaque compte. Pour savoir qui se place où, ouvrez le Livre des hauts faits en jeu et consultez le classement de Renommée; il se trouve là, pas sur le wiki.",
