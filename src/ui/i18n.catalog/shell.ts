  ...
  en: {
    ...
    loading: {
      ...
      tips: {
        ...
        talents:
          'Tip: talent points can be respecced at any trainer, so experimenting is never permanent.',
        dungeons:
          'Tip: dungeons scale to your party size. Bring friends for a faster, safer clear.',
