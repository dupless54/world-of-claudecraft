  ...
  entities: {
    abilities: abilityTranslations([
      ...
      [
        'maul',
        'Maul',
        'A mauling attack that increases melee damage by {damage} and causes a high amount of threat. Activates on your next swing. Bear Form only.',
      ],
      [
        'growl',
        'Growl',
      ...
      [
        'swipe',
        'Swipe',
        'Swipe nearby enemies for {damage} damage. Causes extra threat. Bear Form only.',
      ],
      [
        'regrowth',
        'Regrowth',
