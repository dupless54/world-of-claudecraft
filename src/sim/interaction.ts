...
export function harvestCorpse(
  ...
  for (const y of yields) {
    ...
    // plain fungible grant at the (focus-adjusted) tier quantity, same as
    // before this issue. One rarity roll per yielded component, independent of
    // that component's tier roll above (resolveCorpseFocusHarvest).
