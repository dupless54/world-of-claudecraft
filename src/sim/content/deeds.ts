...
export const DEEDS: Record<string, DeedDef> = {
  ...
  exp_vale_wayfarer: {
    ...
    trigger: {
      ...
      markIds: [
        'poi:eastbrook_vale:Eastbrook',
        'poi:eastbrook_vale:Wolf Run',
        'poi:eastbrook_vale:Boar Meadow',
        'poi:eastbrook_vale:Mirror Lake',
        'poi:eastbrook_vale:Sableweb',
        'poi:eastbrook_vale:Copper Dig',
        'poi:eastbrook_vale:Bandit Camp',
        'poi:eastbrook_vale:Fallen Chapel',
        'poi:eastbrook_vale:Reliquary Hill',
        'poi:eastbrook_vale:Brightwood Glade',
        'poi:eastbrook_vale:The Sowfield',
      ],
    },
  },
  exp_marsh_wayfarer: {
    ...
    trigger: {
      ...
      markIds: [
        'poi:mirefen_marsh:Fenbridge',
        'poi:mirefen_marsh:Prowler Reeds',
        'poi:mirefen_marsh:Deepfen Shallows',
        'poi:mirefen_marsh:Widow Thicket',
        'poi:mirefen_marsh:Drowned Chapel',
        'poi:mirefen_marsh:Troll Mounds',
        'poi:mirefen_marsh:Gravecaller Encampment',
        'poi:mirefen_marsh:The Sunken Bastion',
      ],
    },
  },
  exp_peaks_wayfarer: {
    ...
    trigger: {
      ...
      markIds: [
        'poi:thornpeak_heights:Highwatch',
        'poi:thornpeak_heights:Stalker Ridge',
        'poi:thornpeak_heights:Deeprock Burrows',
        'poi:thornpeak_heights:Ogre Foothills',
        "poi:thornpeak_heights:Drogmar's War-Camp",
        'poi:thornpeak_heights:Stormcrag',
        'poi:thornpeak_heights:The Glimmermere',
        'poi:thornpeak_heights:Wyrmcult Tents',
        'poi:thornpeak_heights:Revenant Fields',
        'poi:thornpeak_heights:Gravewyrm Sanctum',
      ],
    },
  },
  exp_world_traveler: {
