...
export const BIND_ACTIONS: BindAction[] = [
  ...
  // Damage Meters claimed the last free ergonomic letter (KeyZ), so the Book
  // of Deeds parks on the shifted layer of the same key, like the Shift+digit
  // secondary bar. Rebindable like any other action.
  {
    id: 'deeds',
    label: 'Book of Deeds',
    category: 'Interface',
